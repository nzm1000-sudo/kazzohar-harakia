...
@class NSBundle;
@class NSCoder;
SWIFT_RESILIENT_CLASS("_TtC3App22KZBridgeViewController")
@interface KZBridgeViewController : CAPBridgeViewController <CLLocationManagerDelegate, WKScriptMessageHandler>
- (void)viewDidLoad;
