...
#ifndef IONGEOLOCATIONLIB_SWIFT_H
#define IONGEOLOCATIONLIB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IONGeolocationLib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17IONGeolocationLib21IONGLOCManagerWrapper")
@interface IONGLOCManagerWrapper : NSObject
