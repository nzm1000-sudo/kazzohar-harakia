...
#ifndef LOCALNOTIFICATIONSPLUGIN_SWIFT_H
#define LOCALNOTIFICATIONSPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LocalNotificationsPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC24LocalNotificationsPlugin25LocalNotificationsHandler")
...
@interface LocalNotificationsPlugin : CAPPlugin <CAPBridgedPlugin>
...
- (void)checkExactNotificationSetting:(CAPPluginCall * _Nonnull)call;
- (void)changeExactNotificationSetting:(CAPPluginCall * _Nonnull)call;
