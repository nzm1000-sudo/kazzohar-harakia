...
export default function AboutPage({ onNav }) {
  return <section className="about-page">
    ...
    {onNav && <button type="button" className="ghost" onClick={() => onNav('debug/jewish-context')}>אבחון הקשר יהודי</button>}
    <div className="about-sections">
      ...
      <section><h2>רישיונות</h2><p>פתחו את <strong>מידע על המקור</strong> בכל קורא כדי לראות את שם המהדורה, הרישיון, המקור וקישור הנתונים המתאימים לטקסט שנבחר.</p></section>
