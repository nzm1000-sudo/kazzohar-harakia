...
export const MORE = [['halacha','הלכה'],['talmud','תלמוד'],['parasha','פרשה'],['learning','לימוד'],['personal-tools','כלים אישיים'],['travel','מצב נסיעה יהודי'],['shabbat-page','דף שבת'],['preparation','הכנה לשבת ולחג'],['offline','תוכן ללא אינטרנט'],['about','אודות ומקורות']];
