...
const INSTRUCTION_START = /^(יש אומרים|בעשרת ימי תשובה|בראש חודש|בחנוכה ובפורים|אם שכח|נוהגים לומר|יחזור|מדלגים|אומר(?:ים)?(?: ב| לפני| אחר)|כשחל|כשאין|במקום זה|אין אומרים)/;
